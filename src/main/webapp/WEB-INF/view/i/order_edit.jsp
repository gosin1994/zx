				...
				<div class="row-fluid sorprinter">
					<div class="box span12">
						<div class="box-header" data-original-title>
							<h2>
										<i class="halflings-icon edit"></i><span class="break"></span>订单修改
							</h2>
						...
						<div class="box-content">
							<form class="form-horizontal" method="post"
								action="${contextPath}/i/order/${order.id}"
								...
								<fieldset>
									...
									<div class="control-group">
										<label class="control-label" for="focusedInput"><span style="color:red">*</span> 订单金额：</label>
										<div class="controls">
											<printer><tr>
											<td><input name="amount" class="input-xlarge focused" id="amount" maxlength="10" type="text"  value="${order.amount}"></td>
