			...
			<div class="row-fluid">
				...
				<div class="login-box">
					...
					<h3>填选择</h3>
						...
						<a href="${pageContext.request.contextPath}/o/customer/success?cid=${customer.id}">只想入户</a>
						
						
						<a href="${pageContext.request.contextPath}/o/member/apply?cid=${customer.id}">升级为会员，立减200</a>
