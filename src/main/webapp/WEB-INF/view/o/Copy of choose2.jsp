...
<p>感谢您提交资料，注册成为会员入户费用立减300，并可推荐他人入户赚取佣金，您是否要注册为会员？</p>  
<p class="btn-app-store"><a class="btn btn-danger btn-lg" href="${pageContext.request.contextPath}/o/customer/success?cid=${customer.id}" style="padding:10px 20px;">谢谢，我只想入户</a></p>
<p class="btn-app-store"><a class="btn btn-danger btn-lg" href="${pageContext.request.contextPath}/o/member/apply?cid=${customer.id}" style="padding:10px 20px;">前去注册会员，立减300</a></p> 
<br/>
